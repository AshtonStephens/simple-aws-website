...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://tyv5dn7m4g.execute-api.us-west-2.amazonaws.com/prod';
    ...
    apigClient.messagesMessageIdGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['message_id'], ['body']);
        
        var messagesMessageIdGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/messages/{message_id}').expand(apiGateway.core.utils.parseParametersToObject(params, ['message_id'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.messagesMessageIdOptions = function (params, body, additionalParams) {
        ...
        var messagesMessageIdOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/messages/{message_id}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
