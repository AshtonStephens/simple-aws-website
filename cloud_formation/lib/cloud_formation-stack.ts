...
export class CloudFormationStack extends cdk.Stack {
    ...
    */
    createOrUpdateMessageServerApi(serverLambda: lambda.Function): apig.LambdaRestApi {
        ...
        // Add CORS Preflight steps.
        const corsPreflightOptions : apig.CorsOptions = {
            allowOrigins: ["*"],
            allowCredentials: true,
        }

        restApi.root.addCorsPreflight(corsPreflightOptions);
        messages.addCorsPreflight(corsPreflightOptions);
        message.addCorsPreflight(corsPreflightOptions);
