...
The pipelines design is as follows.
...
decided to use nix for the same reason I did and they hated them. So I changed course.

# Getting Started

To get started, read the individual instructions in the sub-directories.

## Development Setup

The most detailed description for putting together the repo will be found in each sub-folder directly,
